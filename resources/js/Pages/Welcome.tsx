...
import classes from '@/Pages/Unify_css/welcome.module.css'
import Eni from '@/Pages/eni.png'
import Xpoly from '@/Pages/xpoly.png'

import JuryEni from '@/Pages/assets/JURY_RDPP.pdf'
import JuryETRE from '@/Pages/assets/JURY_ETRE.pdf'
        ...
        <>
            ...
            <GuestLayout>
                <div className={classes.welcomecontainer}>
                    <div className={classes.welcomeupbars}>
                        <div className={classes.welcomeupbarsbars}>
                            <div className={classes.bar1} onClick={() => window.open(JuryEni)}>
                                <div className={classes.barimage}><img src={Eni} alt="" /></div>
                                <div className={classes.bartext}>
                                    <h2> MASTèRe ENI</h2>
                                    <span>Résultats disponibles.</span>
                                </div>
                            </div>
                            <div className={classes.bar2} onClick={() => window.open(JuryETRE)}>
                                <div className={classes.barimage}><img src={Xpoly} alt="" /></div>
                                <div className={classes.bartext}>
                                    <h2> MASTèRe ETRE</h2>
                                    <span>Résultats disponibles.</span>
                                </div>
